...
namespace WebBanHang.Controllers
{
    ...
    {
        private readonly Vshop2024Context _context;

        public HoaDonsController(Vshop2024Context context)
        {
            _context = context;
        }
        ...
        {
            var vshop2024Context = _context.HoaDons.Include(h => h.MaKhNavigation).Include(h => h.MaNvNavigation).Include(h => h.MaTrangThaiNavigation);
            return View(await vshop2024Context.ToListAsync());
        }
